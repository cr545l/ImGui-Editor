...
namespace imgui_editor
{
	...
	void serialize_or_deserialize(std::string& inout, std::string& version, const bool is_read, T* data, const char* format, Args ... args)
	{
		if (is_read)
		{
    ...
    void parse_args_data(const widget_type type, void* data, std::string& inout, std::string& version, const bool is_read)
    {        
        switch (type)
        {
...
#pragma region // Windows
        case widget_type::widget_type_begin_end_window:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%b,%d", 
                wd->open, wd->flags);
            return;
        }
...
#pragma region // Parameters stacks (current window)
        case widget_type::widget_type_push_pop_item_width:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%f", wd->item_width);
            return;
        }
...
#pragma region // Cursor / Layout
        ...
        case widget_type::widget_type_same_line:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%f,%f", wd->offset_from_start_x, wd->spacing);
            return;
        }
        ...
        case widget_type::widget_type_dummy: 
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%f,%f", wd->size.x, wd->size.y);
            return;
        }
        case widget_type::widget_type_indent: 
        {
            widget_indent* wd = (widget_indent*)data;
            serialize_or_deserialize(inout, version, is_read, wd, "%f", wd->indent_w);
            return;
        }
...
#pragma region // Widgets: Text
        ...
        case widget_type::widget_type_label_text:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%s,", 
                to_safe_string2(is_read, wd->text).c_str());
            return;
        }
...
#pragma region // Widgets: Main
        ...
        {    
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%b,", wd->check);
            return;
        }
        case widget_type::widget_type_checkbox_flags:
        {
            widget_checkbox_flags* wd = (widget_checkbox_flags*)data;
            serialize_or_deserialize(inout, version, is_read, wd, "%d,%d,", wd->flags, wd->flags_value);
            return;
        }
        case widget_type::widget_type_radio_button:
        {
            widget_radio_button* wd = (widget_radio_button*)data;
            serialize_or_deserialize(inout, version, is_read, wd, "%b,", wd->active);
            return;
        }
...
#pragma region // Widgets: Combo Box
        case widget_type::widget_type_begin_end_combo:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%s,%d", 
                to_safe_string2(is_read, wd->preview_value).c_str(), wd->flags);
            return;
        }
...
#pragma region // Widgets: Drag Sliders
        case widget_type::widget_type_drag_float:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%f,%f,%f,%f,%s,%d", 
                wd->value, 
                wd->speed, wd->min, wd->max, to_safe_string2(is_read, wd->format).c_str(), wd->flags);
            return;
        }
...
#pragma region // Widgets: Regular Sliders
        case widget_type::widget_type_slider_float:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%f,%f,%f,%s,%d", 
                wd->value, 
                wd->min, wd->max, to_safe_string2(is_read, wd->format).c_str(), wd->flags);
            return;
        }
...
#pragma region // Widgets: Input with Keyboard
        case widget_type::widget_type_input_text:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%s,%d,",
                to_safe_string2(is_read, wd->text).c_str(), wd->flags);
            return;
        }
        case widget_type::widget_type_input_text_multiline:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%s,%f,%f,%d,", 
                to_safe_string2(is_read, wd->text).c_str(), wd->size.x, wd->size.y, wd->flags);
            return;
        }
        case widget_type::widget_type_input_text_with_hint:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, 
                "%s,%s,%d,", 
                to_safe_string2(is_read, wd->text).c_str(), to_safe_string2(is_read, wd->hint).c_str(), wd->flags);
            return;
        }
...
#pragma region // Widgets: Trees
        case widget_type::widget_type_push_pop_tree_node:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%d", wd->flags);
            return;
        }
...
#pragma region // Widgets: Menus2
        ...
        case widget_type::widget_type_begin_end_menu:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%d", wd->enabled);
            return;
        }
        case widget_type::widget_type_menu_item:
        {
            widget_menu_item* wd = (widget_menu_item*)data;
            serialize_or_deserialize(inout, version, is_read, wd, "%s,%b,%b",
                to_safe_string2(is_read, wd->shortcut).c_str(),
                wd->selected, 
                wd->enabled);
            return;
        }
...
#pragma region // Popups, Modals
        case widget_type::widget_type_begin_end_popup:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%f", wd->flags);
            return;
        }
...
#pragma region // Tables
        case widget_type::widget_type_begin_end_table:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%d,%d,%f,%f,%f",
        ...
        case widget_type::widget_type_table_next_row:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%d,%f", wd->flags, wd->min_row_height);
            return;
        }
        ...
        case widget_type::widget_type_table_set_column_index:
        {
            ...
            serialize_or_deserialize(inout, version, is_read, wd, "%d", wd->column_n);
            return;
        }
#pragma endregion // Tables

#pragma region // ImGui-Editor
        case widget_type::widget_type_caller: return;
